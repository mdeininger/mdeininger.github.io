...
puzzle_times <- readRDS("times_data/puzzle_times_4_21_2019.RDS")
color_map <- tibble(who = c("Claire Day", "Steve Day", "Matthew Deininger", "David Deininger"), m_color = c("red", "blue", "orange", "purple"))
